...
from hotpot_platform.cloud.event_hub.auth import AuthContext, get_auth_context, enforce_store_read
...
from hotpot_platform.cloud.event_hub.daily_report_store import daily_report_store
