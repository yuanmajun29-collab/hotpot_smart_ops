...
> - 可行性分析：`docs/火瞳_解决方案架构可行性分析_20260729.md`（6维度，71分B+，GO）

## 权威文档索引

| 文档 | 位置 | 说明 |
|------|------|------|
| 主线PRD | `docs/火瞳_融合PRD_v5.3_主线基线.md` | v5.3i，唯一权威，129项功能，2833行 |
| 解决方案架构 | `docs/火瞳_解决方案架构设计_v1.0.md` | v1.0，10章节，四层技术架构 |
| 可行性分析 | `docs/火瞳_解决方案架构可行性分析_20260729.md` | 6维度评估，71分B+，GO |
...
| 市场调研v2.0 | `docs/火瞳_全网市场调研与可行性评估报告_v2.0_20260728.md` | 7+10家竞品+行业趋势+86分A- |
| 市场调研v5.3c | `docs/火瞳_PRD_v5.3c_市场调研与竞品评估报告_20260728.md` | 10家竞品+行业趋势 |
| 门店标准 | 工作目录 `火瞳_浙江总代门店标准与权益包_v1.0.md` | 定价+权益 |
| 架构设计 | 工作目录 `火瞳_系统架构设计文档_v1.0.md` | 系统架构(旧版) |
