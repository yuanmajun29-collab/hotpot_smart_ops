...
from platform.cloud.event_hub.daily_report_store import PG_DAILY_REPORTS_SCHEMA
from platform.cloud.event_hub.iot_readings_store import PG_IOT_READINGS_SCHEMA
from platform.cloud.event_hub.receiving_store import PG_RECEIVING_SCHEMA
from platform.cloud.event_hub.sop_assign_store import PG_SOP_ASSIGN_SCHEMA
