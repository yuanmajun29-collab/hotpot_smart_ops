...
from platform.cloud.event_hub.auth import AuthContext, get_auth_context, enforce_store_write, enforce_action
from platform.cloud.event_hub.routers._deps import resolve_store_id as _resolve_store_id, SopAssignBody, SopAssignStatusBody, SopAskBody
from platform.cloud.event_hub.sop_assign_store import sop_assign_store
...
def sop_ask(
    ...
    from platform.cloud.llm_report.sop_rag import create_sop_agent
