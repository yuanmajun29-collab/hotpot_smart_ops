...
|---|--------|----------|----------|:----:|:---------:|
| 59 | K13 | 翻台率分析（按时段/桌型） | `edge/front_hall/inference/` | 🔧 代码基础 | P1 |
| 60 | K14 | 加汤提醒（汤位<1/3推送） | — | 📐 规则骨架 | P1 |
| 61 | K15 | 多店对比 Dashboard | `hotpot_platform/` dashboard | 🔧 代码基础 | P1 |
| 62 | K23 | 跨店趋势看板 | `hotpot_platform/analytics/` | 🔧 代码基础 | P1 |
| 63 | K24 | AI 运营建议（建议+追踪闭环） | `hotpot_platform/analytics/` | 🔧 代码基础 | P1 |
| 64 | K28 | 设备健康检测 | — | ⬜ 未来规划 | P2 |
| 65 | K29 | 区域总代看板 | `hotpot_platform/` dashboard | 🔧 代码基础 | P1 |
| 66 | K30 | 微笑/服务态度识别 | `edge/agent/modules/staff_behavior_infer.py` | 🔧 代码基础 | P2 |
| 67 | K32 | 动态告警阈值（时段自适应） | `edge/kitchen/inference/rules.py` | 🔧 代码基础 | P1 |
| 68 | N07 | 供应商画像 | — | ⬜ 未来规划 | P2 |
| 69 | N08 | 供应商评级调整 | — | ⬜ 未来规划 | P2 |
| 70 | N09 | 自动对账（订货-收货-付款） | — | ⬜ 未来规划 | P2 |
| 71 | N10 | AI 排班优化 | — | ⬜ 未来规划 | P2 |
| 72 | N11 | ERP/POS 桥接（API对接） | `integrations/erp_bridge.py` + `pos_bridge.py` | 🔧 代码基础 | P2 |
| 73 | N12 | 加盟商合规审计 | — | ⬜ 未来规划 | Phase 2 |
...
## 3. 状态统计总览（2026-07-29 评审补全后）

| 状态 | 数量 | 占比 | 功能ID示例 |
|------|:----:|:----:|------------|
| ✅ Sprint 0 通过 | **3** | 2.3% | N01, N04, N17 |
| 🔧 已具备代码基础 | **22** | 17.1% | K01-K15,K23-K24,K29-K32,K37,N11 |
...
| **N系列·数据引擎** | 27 | 10(N01-N06,N11-N12,N17-N18) | 37.0% |
| **S系列·供应链** | 4 | 1(S02) | 25.0% |
| **A系列·AI助理** | 5 | 0 | 0% |
...
| 代码覆盖率 | 未统计 | **25.6%(33/129)**（2026-07-29评审补全15项遗漏后） |
