...
from hotpot_platform.cloud.event_hub.rbac import ROLE_ACTIONS, data_scope_for_role
...
def test_auth_mode_reads_env_at_call_time(monkeypatch):
    ...
    from hotpot_platform.cloud.event_hub.auth import auth_mode
...
def test_strict_deployment_profile_rejects_demo_defaults(monkeypatch):
    from hotpot_platform.cloud.event_hub.app import validate_deployment_profile
