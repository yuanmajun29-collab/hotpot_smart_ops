...
def test_due_profiles_matches_hour_minute():
    from hotpot_platform.cloud.event_hub.daily_scheduler import ScheduleProfile, due_profiles
    profiles = [
...
def test_default_loss_profiles_three_slots():
    from hotpot_platform.cloud.event_hub.daily_scheduler import default_loss_profiles, validate_profiles
...
def test_validate_profiles_rejects_ambiguous_or_invalid_config():
    from hotpot_platform.cloud.event_hub.daily_scheduler import ScheduleProfile, validate_profiles
...
def test_run_due_dedups_per_profile_per_store_per_day():
    from hotpot_platform.cloud.event_hub.daily_scheduler import DailyReportScheduler, ScheduleProfile
    calls = []
    profiles = [
        ScheduleProfile("restock", 15, 0, None, "restock"),
        ScheduleProfile("daily_loss", 22, 0, None, "daily"),
...
def test_legacy_single_slot_still_works():
    ...
    from hotpot_platform.cloud.event_hub.daily_scheduler import DailyReportScheduler
    fired = []
